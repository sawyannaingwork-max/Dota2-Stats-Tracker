export default {
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Ghost Form",
        "description": "You enter ghost form for 4 seconds, becoming immune to physical damage, but are unable to attack and -40% more vulnerable to magic damage."
      }
    ],
    "hint": [],
    "id": 37,
    ...
    "abilities": [
      {
        "type": "use",
        "title": "Devour",
        "description": "Consumes a target tree to gain 7 health regeneration for 16 seconds. Consuming an Ironwood Tree doubles the heal amount.\n\nComes with 3 charges. Can be used on an allied hero to give them one Tango.\n\nTree Range: 165"
      }
    ],
    "hint": [],
    "id": 44,
    ...
    "abilities": [
      {
        "type": "passive",
        "title": "Empower Spell",
        "description": "The next Unit Target spell you cast on an enemy deals a separate 250 additional damage and applies a debuff that slows the target by 30% and disables their passives for 4s."
      }
    ],
    "hint": [],
    "id": 1808,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Transmute",
        "description": "Kills a non-hero target for 160 gold and 2.1x experience. Killing a neutral creep additionally grants a madstone bundle. \n\n Cannot be used on Ancient creeps."
      }
    ],
    "hint": [],
    "id": 65,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Arctic Blast",
        "description": "Emits a freezing wave that causes enemies to take 15% more damage from spells for 16 seconds, deals 200 magical damage and slows their movement by -40% for 4 seconds. Deals 150% damage to illusions.\n\nRadius: 900"
      },
      {
        "type": "passive",
        "title": "Freezing Aura",
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Bloodpact",
        "description": "Increases Bloodstone's Spell Lifesteal by 4x. Lasts 5 seconds. \n\nDispel Type: Basic Dispel"
      }
    ],
    "hint": [],
    "id": 121,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Meteor Hammer",
        "description": "CHANNELED - After a successful channel, summons a meteor that strikes a 400 AoE, stunning enemies for 0.5 seconds and dealing impact damage. Continues to deal damage over time to enemies units and buildings for 6 seconds. Non-building units are also slowed for 20% for the duration of the burn. \n\nBuilding Impact Damage: 90 \nBuilding Over Time Damage: 50 \n\nNon-Building Impact Damage: 130 \nNon-Building Over Time Damage: 50 \n\nChannel Duration: 2 seconds.\nLanding Time: 0.5 seconds."
      }
    ],
    "hint": [],
    "id": 223,
    ...
    "abilities": [
      {
        "type": "toggle",
        "title": "Burn",
        "description": "When active, scorches enemies for 60 magical damage per second and causes them to miss 15% of their attacks. Deals 150% damage to illusions. Illusions deal 35 magical damage per second.\n\nRadius: 650"
      }
    ],
    "hint": [],
    "id": 137,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Dominate",
        "description": "Takes control of one neutral, non-ancient target unit and sets its movement speed to 380 and max health to a minimum of 1000. Also provides the unit with +25 base attack damage, +12 health regen, +4 mana regen and +4 armor. \n\nDominated units with a max health of greater than 1000 retain their original max health. Grants the caster the gold and experience bounty of the dominated creep. Dominated unit's bounty is set to 100 gold and it can no longer be killed by abilities that instantly kill creeps otherwise."
      }
    ],
    "hint": [],
    "id": 164,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Suppress",
        "description": "Slows the target for 5 seconds if they are an enemy or applies a basic dispell and grants bonus movespeed and 40% slow resistance for 5 seconds if they are an ally. Caster is always granted the ally benefit on cast.\n\nBoth movement speed reduction and increase start at 100% and gradually decrease to 0% over the course of the buff duration.\nDispel Type: Basic Dispel"
      },
      {
        "type": "passive",
        "title": "Manabreak",
  ...
  "ethereal_blade": {
    "abilities": [
      {
        "type": "active",
        "title": "Ether Blast",
        "description": "Converts the target unit to ethereal form, rendering them immune to physical damage, but unable to attack and -40% more vulnerable to magic damage.\n\n Enemy targets are also slowed by -80%, and take 1.5x your target's primary attribute + 50 as magical damage.\nDuration: 4 seconds"
      }
    ],
    "hint": [],
    "id": 176,
    ...
    "attrib": [
      ...
      {
        "key": "universal_multiplier_tooltip",
        "value": "45"
      }
    ],
    "mc": 100,
  ...
  "guardian_greaves": {
    "abilities": [
      ...
      },
      {
        "type": "passive",
        "title": "Guardian Aura",
        "description": "Grants 2.5 health regeneration, 1.5 mana regeneration and 3 armor to allied units. If an allied hero's health falls below 25%, this is increased to 14.5 health regeneration, 5 mana regeneration and 8 armor. \n\nRadius: 1200"
      }
    ],
    "hint": [
      "Movement speed bonuses from multiple pairs of boots do not stack."
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Disarm",
        "description": "Prevents a target from attacking for 3.5 seconds on melee targets, and 4.5 seconds on ranged targets."
      },
      {
        "type": "passive",
        "title": "Damage Block",
    ...
    "abilities": [
      {
        "type": "passive",
        "title": "Reciprocity",
        "description": "When attacked, the hero counter-attacks a target within their attack range. 5s Cooldown."
      }
    ],
    "hint": [],
    "id": 950,
    ...
    "abilities": [
      {
        "type": "passive",
        "title": "Crackshot",
        "description": "Ranged Only. The next attack fires projectiles that deal 10 bonus damage at 2 additional targets within attack range plus a 225 range bonus. Does not trigger attack modifiers."
      }
    ],
    "hint": [],
    "id": 1076,
    ...
    "abilities": [
      {
        "type": "passive",
        "title": "Reverberate",
        "description": "After taking 180 damage from any source, the wearer fires a projectile at up to 2 random enemies in a 600 radius, prioritizing heroes, that deal 125 physical damage and slow the targets movement and attack speed by 100% for 0.2s."
      }
    ],
    "hint": [],
    "id": 1168,
    ...
    "abilities": [
      {
        "type": "passive",
        "title": "Relentless",
        "description": "Increases slow resistance by 100%. This bonus is reduced by 20% for every enemy hero within 600 units.\n\nIncreases status resistance by 10% for every enemy hero within 600 units."
      }
    ],
    "hint": [],
    "id": 1598,
    ...
    "abilities": [
      {
        "type": "passive",
        "title": "Burn Through",
        "description": "Instances of magic damage from spells over 55 ignites enemies, causing them to take 72 magic damage over 6 seconds."
      }
    ],
    "hint": [],
    "id": 1604,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Retribution",
        "description": "For the next 6 seconds, 75% of damage taken by the caster is reflected to the target unit as physical damage."
      }
    ],
    "hint": [],
    "id": 1608,
    ...
    "abilities": [
      {
        "type": "active",
        "title": "Self-Exile",
        "description": "Removes the caster from the world for 0.7 seconds, making them invulnerable and disabled. When returning to the world, the caster takes 5% of their maximum health as damage."
      }
    ],
    "hint": [],
    "id": 1641,
    ...
    "abilities": [
      {
        ...
        "description": "Spells have a 12% larger Area of Effect, but now additionally cost health equal to 35% of their mana cost."
      }
    ],
    "hint": [],
    "id": 1642,
